...
class ServicedObject
{
    ...
    //#[ORM\OneToMany(mappedBy: 'serviced_object', targetEntity: File::class, orphanRemoval: true)]
    /**
     * @ORM\OneToMany(targetEntity="File::class", mappedBy="serviced_object",cascade={"persist"}, orphanRemoval="true")
     */
